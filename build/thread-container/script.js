...
!function() {
/*!****************************************!*\
  !*** ./src/thread-container/script.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
...
function drawaThread(e) {
  e.forEach(el => {
    ...
    const scrollPercentage = (el.getBoundingClientRect().top - window.innerHeight + 200) / (window.innerHeight / 2 * -1);
    ...
    scrollPercentage >= 0.99 ? el.style.strokeDasharray = "none" : scrollPercentage <= 0 ? el.style.strokeDashoffset = pathLength : el.style.strokeDasharray = pathLength + " " + pathLength;
  });
}
...
window.addEventListener("DOMContentLoaded", function (e) {
  const paths = [...document.querySelectorAll("[class^='background-curve'] path")];
